...
class clippedLossVector(nn.Module):
    ...
    def forward(self, model, model_old, eps, c_1, src, generated, actions, rewards, eos_mask, device, include_src_state=False):
        """
        Parameters:
            ...
            eos_mask : mask of time points after the sequence has ended (True for t > T)
            device   : cpu / gpu
        """
